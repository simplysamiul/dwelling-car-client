        ...
        <TableBody>
          {cars.map((row) => (
            <StyledTableRow key={row._id}>
              ...
              <StyledTableCell align="right"><img style={{width:"80px"}} src={row.car_img} alt="" /></StyledTableCell>
              <StyledTableCell align="right"><i onClick={()=> handelDeletecar(row._id)} style={{fontSize:"25px", color:"red", cursor : "pointer"}} className="fas fa-times-circle"></i></StyledTableCell>
            </StyledTableRow>
          ))}
        </TableBody>
      </Table>
